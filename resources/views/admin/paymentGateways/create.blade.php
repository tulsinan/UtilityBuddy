...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.paymentGateway.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payment-gateways.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gateway_address') ? 'is-invalid' : '' }}" type="text" name="gateway_address" id="gateway_address" value="{{ old('gateway_address', '') }}" required>
